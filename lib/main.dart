...
void main() async {
  ...
  if (app_language.$ == null || app_language.$!.isEmpty) {
    app_language.$ = "ar";
    await app_language.save();
  }
        ...
        routes: [
          ...
          GoRoute(
            ...
            pageBuilder: (BuildContext context, GoRouterState state) {
              ...
              return MaterialPage(child: Login(redirectRoute: redirectRoute));
            },
          ),
          GoRoute(
