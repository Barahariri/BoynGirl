...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(0, 206, 209, 0.40);
  static const Color accent_color_shadow = Color.fromRGBO(0, 206, 209, 0.40); // this color is a dropshadow of
  static Color soft_accent_color = Color(0xFF00FFFF);
  static Color splash_screen_color = Color(0xFF00CED1);// if not sure , use the same color as accent color
  ...
  static const Color gigas =  Color(0xFF00CED1);
  static const Color polo_blue = Color(0xFF00FFFF);
  //------------
  static const Color blue_chill = Color(0xFF00CED1);
  static const Color cruise = Color(0xFF00FFFF);
  //---------------
