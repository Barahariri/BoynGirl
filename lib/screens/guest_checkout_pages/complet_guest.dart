...
class _GuestCheckoutAddressState extends State<GuestCheckoutAddress> {
  ...
  bool requiredFieldVerification() {
    // إذا لم تعد تحتاج التحقق من الاسم والإيميل يمكنك حذف الشروط الخاصة بهما:
    // emailValid = ...  // يمكن حذف هذا السطر أيضًا إذا لم تعد تستخدم البريد الإلكتروني
  ...
  Future<void> continueToDeliveryInfo() async {
    ...
    // هنا نقوم بتجاهل نتيجة الفحص بحيث يُستمر التنفيذ دائمًا
    // Loading.close();

    // حتى لو كانت النتيجة true (أي يوجد حساب)، نتجاهلها
    postValue.addAll({
      "name": name!,
      "address": address!,
      "country_id": country!,
                          ...
                          child: Container(
                            ...
                            child: TypeAheadField(
                              ...
                              suggestionsCallback: (pattern) async {
                                var countryResponse =
                                await AddressRepository().getCountryList(name: pattern);
