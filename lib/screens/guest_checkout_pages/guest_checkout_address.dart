...
class _GuestCheckoutAddressState extends State<GuestCheckoutAddress> {
  ...
  Future<void> continueToDeliveryInfo() async {
    ...
    // نقوم بتجميع القيم المطلوبة في postValue
    ...
    // يمكننا حذف الفحص الخاص بوجود حساب مسجّل
    ...
    // تحويل البيانات النهائية إلى JSON
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            builder: (context, controller, focusNode) {
                              return TextField(
                                ...
                                decoration: buildAddressInputDecoration(
                                    context, AppLocalizations.of(context)!.enter_country_ucf),
                              );
                            },
                            ...
                            itemBuilder: (context, dynamic country) {
                              return ListTile(
                                dense: true,
                                title: Text(country.name, style: TextStyle(color: MyTheme.font_grey)),
                              );
                            },
                            onSelected: (value) {
                          ...
                          child: TypeAheadField(
                            ...
                            builder: (context, controller, focusNode) {
                              return TextField(
                                ...
                                focusNode: focusNode,
                                decoration: buildAddressInputDecoration(
                                    context, AppLocalizations.of(context)!.enter_state_ucf),
                              );
                            },
                            suggestionsCallback: (pattern) async {
                              if (_selected_country == null) {
                              ...
                              var stateResponse = await AddressRepository().getStateListByCountry(
                                  country_id: _selected_country!.id, name: pattern);
                              return stateResponse.states;
                            },
                            loadingBuilder: (context) {
                              return Container(
                            ...
                            itemBuilder: (context, dynamic state) {
                              return ListTile(
                                dense: true,
                                title: Text(state.name, style: TextStyle(color: MyTheme.font_grey)),
                              );
                            },
                            onSelected: (value) {
                          ...
                          child: TypeAheadField(
                            ...
                            builder: (context, controller, focusNode) {
                              return TextField(
                                ...
                                focusNode: focusNode,
                                decoration: buildAddressInputDecoration(
                                    context, AppLocalizations.of(context)!.enter_city_ucf),
                              );
                            },
                            suggestionsCallback: (pattern) async {
                              if (_selected_state == null) {
                              ...
                              var cityResponse = await AddressRepository().getCityListByState(
                                  state_id: _selected_state!.id, name: pattern);
                              return cityResponse.cities;
                            },
                            loadingBuilder: (context) {
                              return Container(
                            ...
                            itemBuilder: (context, dynamic city) {
                              return ListTile(
                                dense: true,
                                title: Text(city.name, style: TextStyle(color: MyTheme.font_grey)),
                              );
                            },
                            onSelected: (value) {
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: buildAddressInputDecoration(
                                context, AppLocalizations.of(context)!.enter_postal_code_ucf),
                          ),
                        ),
                      ),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: buildAddressInputDecoration(
                                context, AppLocalizations.of(context)!.enter_phone_number),
                          ),
                        ),
                      ),
                    ],
