...
class _AddressState extends State<Address> {
  ...
  onAddressSwitch(index) async {
    var addressMakeDefaultResponse = await AddressRepository().getAddressMakeDefaultResponse(index);
  ...
  confirmDelete(id) async {
    var addressDeleteResponse = await AddressRepository().getAddressDeleteResponse(id);
  ...
  onSelectStateDuringUpdate(index, state, setModalState) {
    if (_selected_state_list_for_update[index] != null && state.id == _selected_state_list_for_update[index]!.id) {
      setModalState(() {
                        ...
                        child: Column(
                          children: [
                            Text(
                              ...
                              style: TextStyle(fontSize: 13, color: MyTheme.dark_font_grey, fontWeight: FontWeight.bold),
                            ),
                            Icon(
                              Icons.add_sharp,
                              color: MyTheme.accent_color,
        ...
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setModalState) {
            return AlertDialog(
              ...
              contentPadding: EdgeInsets.only(top: 23.0, left: 20.0, right: 20.0, bottom: 2.0),
              content: Container(
                width: 400,
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(color: Color(0xff3E4447), fontWeight: FontWeight.bold, fontSize: 12),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.enter_your_name),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            suggestionsCallback: (pattern) async {
                              var countryResponse = await AddressRepository().getCountryList(name: pattern);
                            ...
                            loadingBuilder: (context) {
                              return Container(
                                ...
                                child: Center(
                                  child: Text(
                                    AppLocalizations.of(context)!.loading_countries_ucf,
                                    style: TextStyle(color: MyTheme.medium_grey),
                                  ),
                                ),
                              );
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            suggestionsCallback: (pattern) async {
                              if (_selected_country == null) {
                                var stateResponse = await AddressRepository().getStateListByCountry();
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.enter_postal_code_ucf),
                          ),
                        ),
                      ),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.enter_phone_number),
                          ),
                        ),
                      ),
                    ],
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            suggestionsCallback: (name) async {
                              var countryResponse = await AddressRepository().getCountryList(name: name);
                              return countryResponse.countries;
                            },
                            loadingBuilder: (context) {
                              return Container(
                                height: 50,
                                child: Center(child: Text(AppLocalizations.of(context)!.loading_countries_ucf, style: TextStyle(color: MyTheme.medium_grey))),
                              );
                            },
                            itemBuilder: (context, dynamic country) {
                              return ListTile(
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            loadingBuilder: (context) {
                              return Container(
                                height: 50,
                                child: Center(child: Text(AppLocalizations.of(context)!.loading_states_ucf, style: TextStyle(color: MyTheme.medium_grey))),
                              );
                            },
                            itemBuilder: (context, dynamic state) {
                              return ListTile(
                        ...
                        child: Container(
                          ...
                          child: TypeAheadField(
                            ...
                            loadingBuilder: (context) {
                              return Container(
                                height: 50,
                                child: Center(child: Text(AppLocalizations.of(context)!.loading_cities_ucf, style: TextStyle(color: MyTheme.medium_grey))),
                              );
                            },
                            itemBuilder: (context, dynamic city) {
                              return ListTile(
                            ...
                            onSelected: (value) {
                              onSelectCityDuringUpdate(index, value, setModalState);
                            },
                          ),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Text(AppLocalizations.of(context)!.postal_code, style: TextStyle(color: MyTheme.font_grey, fontSize: 12)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(bottom: 16.0),
                        child: Container(
                      ...
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Text(AppLocalizations.of(context)!.phone_ucf, style: TextStyle(color: MyTheme.font_grey, fontSize: 12)),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Container(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Btn.minWidthFixHeight(
                        ...
                        color: Color.fromRGBO(253, 253, 253, 1),
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(6.0), side: BorderSide(color: MyTheme.light_grey, width: 1.0)),
                        child: Text(
      ...
      title: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(fontSize: 16, color: Color(0xff3E4447), fontWeight: FontWeight.bold),
          ),
          Text(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecorations.buildBoxDecoration_1().copyWith(
            border: Border.all(
                color: _default_shipping_address == _shippingAddressList[index].id ? MyTheme.accent_color : MyTheme.light_grey,
                width: _default_shipping_address == _shippingAddressList[index].id ? 1.0 : 0.0)),
        child: Stack(
          children: [
            Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            AppLocalizations.of(context)!.address_ucf,
                            style: TextStyle(color: const Color(0xff6B7377), fontWeight: FontWeight.normal),
                          ),
                        ),
                        Container(
                          width: 175,
      ...
      child: PopupMenuButton<MenuOptions>(
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: Image.asset("assets/more.png", width: 4, height: 16, fit: BoxFit.contain, color: MyTheme.grey_153),
          ),
        ),
