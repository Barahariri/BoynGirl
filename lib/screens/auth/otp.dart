...
class Otp extends StatefulWidget {
  ...
  Otp({Key? key, this.title, this.redirectRoute}) : super(key: key);
  @override
...
class _OtpState extends State<Otp> {
  ...
  onTapResend() async {
    try {
      ...
      ToastComponent.showDialog("An error occurred while resending the code. Please try again.", gravity: Toast.center, duration: Toast.lengthLong);
    }
  }
  onPressConfirm() async {
    ...
    try {
      ...
      ToastComponent.showDialog("An error occurred while confirming the code. Please try again.", gravity: Toast.center, duration: Toast.lengthLong);
    }
  }
  @override
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextField(
                                ...
                                autofocus: false,
                                decoration: InputDecorations.buildInputDecoration_1(hint_text: "A X B 4 J H"),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Btn.basic(
                                ...
                                child: Text(AppLocalizations.of(context)!.confirm_ucf, style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)),
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        onTap: onTapResend,
                        child: Text(AppLocalizations.of(context)!.resend_code_ucf, textAlign: TextAlign.center, style: TextStyle(color: MyTheme.accent_color, decoration: TextDecoration.underline, fontSize: 13)),
                      ),
                    ),
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        child: Text(AppLocalizations.of(context)!.logout_ucf, textAlign: TextAlign.center, style: TextStyle(color: MyTheme.accent_color, decoration: TextDecoration.underline, fontSize: 13)),
                      ),
                    ),
                  ],
                ),
  ...
  onTapLogout(context) async {
    try {
      ...
      ToastComponent.showDialog("An error occurred while logging out. Please try again.", gravity: Toast.center, duration: Toast.lengthLong);
    }
  }
}